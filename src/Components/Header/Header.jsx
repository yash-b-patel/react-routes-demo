        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8">
            <nav className="relative flex items-center justify-between h-16 lg:h-20">
                <div className="hidden lg:flex lg:items-center lg:space-x-10">
                    <NavLink to="/"  className="text-base font-medium text-black"> Home </NavLink>

                    <NavLink to="/About"  className="text-base font-medium text-black"> About </NavLink>

                    <NavLink to="/Resource"  className="text-base font-medium text-black"> Resources </NavLink>

                    <NavLink to="/Pricing"  className="text-base font-medium text-black"> Pricing </NavLink>
                </div>
